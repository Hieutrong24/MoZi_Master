    ...
    const interval = setInterval(() => {
      if (loading <= max) {
        if (loading == biteTime * (bitesTaken + 1)) {
          if (document.getElementById(biteIds[bitesTaken])) document.getElementById(biteIds[bitesTaken]).style.opacity = '1';
          bitesTaken++;
        }
        loading++;
      } else {
  ...
  return (
    <div className="container">
      <div className="row justify-content-lg-end justify-content-center">
        ...
        <div className="border rounded-4 col-12 col-sm-10 col-md-8 col-lg-6 p-4 bg-dark text-white ui">
          <h5 className="fw-bold text-center text-danger">ĐĂNG KÝ</h5>
